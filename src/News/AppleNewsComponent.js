...
const AppleNewsComponent = () => {
  ...
  // Pagination logic
  const totalPages = Math.ceil(appleNews.length / newsPerPage);
  ...
  return (
    <div>
      <h2 className="mb-4 text-center">Apple Related News</h2>
      {loading ? (
...
export default AppleNewsComponent;
